...
var idpay_error_codes_1 = require("./interfaces/idpay-error-codes");
var IDPay = /** @class */ (function () {
     ...
     */
    IDPay.prototype.paymentRequest = function (payment) {
        return __awaiter(this, void 0, void 0, function () {
            var response, err_1, response_1, errorDesc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default.post(cfg_1.config.createPaymentURL, payment, {
                                headers: {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        response_1 = err_1.response;
                        errorDesc = idpay_error_codes_1.idPayErrorCodes[response_1.error_code];
